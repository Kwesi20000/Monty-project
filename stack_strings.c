...
/**
 * print_character - Function prints the Ascii value.
 * @stack: Pointer to a pointer pointing to top node of the stack.
 * @line_num: Integer representing the line number of of the opcode.
 */
void print_character(stack_t **stack, unsigned int line_num)
{
	int ascii;
...
/**
 * rotl - Functio rotates the first node of the stack to the bottom.
 * @stack: Pointer to a pointer pointing to top node of the stack.
 * @line_num: Integer representing the line number of of the opcode.
 */
